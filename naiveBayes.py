...
YEARS = ['20']
INPUT_FILE_PATH = "/media/parik/New Volume/SDM/R Lab/Final Project Ariline Delay/Data-Mining-Project-master/airline/"  # Unix path
...
# Calculating metrics using sklearn metrics functions
    ...
    print(classification_report(np.array(sampled_test['label'])))
    train = []
    test = []
